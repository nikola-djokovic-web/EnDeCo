...
<head>
	...
	<link href="/templates/frontend/assets/plugins/socicon/socicon.css" rel="stylesheet" type="text/css"/>
	<link href="/templates/frontend/assets/plugins/bootstrap-social/bootstrap-social.css" rel="stylesheet" type="text/css"/>
	<link href="/templates/frontend/assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
	<link href="/templates/frontend/assets/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet" type="text/css"/>
	<link href="/templates/frontend/assets/plugins/animate/animate.min.css" rel="stylesheet" type="text/css"/>
	<link href="/templates/frontend/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
	<!-- END GLOBAL MANDATORY STYLES -->

			<!-- BEGIN: BASE PLUGINS  -->
			<link href="/templates/frontend/assets/plugins/revo-slider/css/settings.css" rel="stylesheet" type="text/css"/>
			<link href="/templates/frontend/assets/plugins/revo-slider/css/layers.css" rel="stylesheet" type="text/css"/>
			<link href="/templates/frontend/assets/plugins/revo-slider/css/navigation.css" rel="stylesheet" type="text/css"/>
			<link href="/templates/frontend/assets/plugins/cubeportfolio/css/cubeportfolio.min.css" rel="stylesheet" type="text/css"/>
			<link href="/templates/frontend/assets/plugins/owl-carousel/assets/owl.carousel.css" rel="stylesheet" type="text/css"/>
			<link href="/templates/frontend/assets/plugins/fancybox/jquery.fancybox.css" rel="stylesheet" type="text/css"/>
			<link href="/templates/frontend/assets/plugins/slider-for-bootstrap/css/slider.css" rel="stylesheet" type="text/css"/>
				<!-- END: BASE PLUGINS -->
...
</head><body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-fullscreen c-layout-header-topbar">

	<!-- BEGIN: LAYOUT/HEADERS/HEADER-ONEPAGE -->
<!-- BEGIN: HEADER -->
<header class="c-layout-header c-layout-header-onepage c-layout-header-2 c-bordered c-layout-header-dark-mobile c-header-transparent-dark" id="home" data-minimize-offset="0">
	<div class="c-navbar">
			...
			<div class="c-navbar-wrapper clearfix">
				<div class="c-brand c-pull-left">
					<a href="index.html" class="c-logo">
						<img src="/templates/frontend/assets/base/img/layout/logos/logo-1.png" alt="JANGO" class="c-desktop-logo">
						<img src="/templates/frontend/assets/base/img/layout/logos/logo-1.png" alt="JANGO" class="c-desktop-logo-inverse">
						<img src="/templates/frontend/assets/base/img/layout/logos/logo-1.png" alt="JANGO" class="c-mobile-logo">
					</a>
										<button class="c-hor-nav-toggler c-quick-sidebar-toggler" type="button">
					<span class="c-line"></span>
					<span class="c-line"></span>
					<span class="c-line"></span>
					</button>
					<a href="javascript:;" data-toggle="modal" data-target="#login-form" class="c-btn-login c-btn-border-opacity-04 c-btn btn btn-sm c-btn-border-1x c-btn-white c-btn-circle c-btn-uppercase c-btn-sbold"><i class="icon-user"></i><span>Sign In</span>
					</a>
...
<nav class="c-mega-menu-onepage-dots c-theme" data-onepage-animation-speed="700">
	<ul class="nav navbar-nav c-onepage-dots-nav">
						<li class="c-onepage-link c-active active">
			<a href="#home" class="c-link tooltips" data-placement="left" data-trigger="hover" data-original-title="Home">
			</a>
		</li>
						<li class="c-onepage-link ">
			<a href="#about" class="c-link tooltips" data-placement="left" data-trigger="hover" data-original-title="About">
			</a>
		</li>
						<li class="c-onepage-link ">
			<a href="#services" class="c-link tooltips" data-placement="left" data-trigger="hover" data-original-title="Features">
			</a>
		</li>
						<li class="c-onepage-link ">
			<a href="#clients" class="c-link tooltips" data-placement="left" data-trigger="hover" data-original-title="Clients">
			</a>
		</li>
						<li class="c-onepage-link ">
			<a href="#demos" class="c-link tooltips" data-placement="left" data-trigger="hover" data-original-title="Demos">
			</a>
		</li>
						<li class="c-onepage-link ">
			<a href="#pricing" class="c-link tooltips" data-placement="left" data-trigger="hover" data-original-title="Pricing">
			</a>
		</li>
						<li class="c-onepage-link ">
			<a href="#contact" class="c-link tooltips" data-placement="left" data-trigger="hover" data-original-title="Contact">
			</a>
		</li>
			</ul>
</nav>
					...
					<div class="col-md-12">
						<a href="../default/index.html" class="c-demo-container c-demo-img-lg">
							<div class="c-demo-thumb active">
								<img src="/templates/frontend/assets/base/img/content/quick-sidebar/default.jpg" class="c-demo-thumb-img"/>
							</div>
						</a>
					</div>
				</div>
					...
					<div class="col-md-6">
						<a href="../corporate_1/index.html" class="c-demo-container">
							<div class="c-demo-thumb  c-thumb-left">
								<img src="/templates/frontend/assets/base/img/content/quick-sidebar/corporate_1.jpg" class="c-demo-thumb-img"/>
							</div>
						</a>
					</div>
					<div class="col-md-6">
						<a href="../agency_1/index.html" class="c-demo-container">
							<div class="c-demo-thumb  c-thumb-right">
								<img src="/templates/frontend/assets/base/img/content/quick-sidebar/corporate_1-onepage.jpg" class="c-demo-thumb-img"/>
							</div>
						</a>
					</div>
				</div>
		...
		<div class="tp-banner rev_slider" data-version="5.0">
			<ul>
				...
				<li data-transition="fade" data-slotamount="1" data-masterspeed="1000">
					<img
						alt=""
						src="/templates/frontend/assets/base/img/content/backgrounds/bg-37.jpg"
				...
				<li data-transition="fade" data-slotamount="1" data-masterspeed="1000">
					<img
						alt=""
						src="/templates/frontend/assets/base/img/content/backgrounds/bg-40.jpg"
						data-bgposition="center center"
						data-bgfit="cover"
						data-bgrepeat="no-repeat"
					>
					...
					<div class="c-logos">
						<div class="row">
							<div class="col-md-3 col-xs-6 c-logo c-logo-1">
								<a href="#"><img class="c-img-pos" src="/templates/frontend/assets/base/img/content/client-logos/client1.jpg" alt=""/></a>
							</div>
							<div class="col-md-3 col-xs-6 c-logo c-logo-2">
								<a href="#"><img class="c-img-pos" src="/templates/frontend/assets/base/img/content/client-logos/client2.jpg" alt=""/></a>
							</div>
							<div class="col-md-3 col-xs-6 c-logo c-logo-3">
								<a href="#"><img class="c-img-pos" src="/templates/frontend/assets/base/img/content/client-logos/client3.jpg" alt=""/></a>
							</div>
							<div class="col-md-3 col-xs-6 c-logo c-logo-4">
								<a href="#"><img class="c-img-pos" src="/templates/frontend/assets/base/img/content/client-logos/client4.jpg" alt=""/></a>
							</div>
							<div class="col-md-3 col-xs-6 c-logo c-logo-5">
								<a href="#"><img class="c-img-pos" src="/templates/frontend/assets/base/img/content/client-logos/client5.jpg" alt=""/></a>
							</div>
							<div class="col-md-3 col-xs-6 c-logo c-logo-6">
								<a href="#"><img class="c-img-pos" src="/templates/frontend/assets/base/img/content/client-logos/client6.jpg" alt=""/></a>
							</div>
						</div>
					</div>
				</div>
...
<div class="c-content-box c-size-md c-bg-parallax" style="background-image: url(/templates/frontend/assets/base/img/content/backgrounds/bg-51.jpg)">
	<div class="container">
		<div class="c-content-feature-8 c-opt-1">
			<ul class="c-grid">
				<li>
					<div class="c-card c-font-right c-bg-opacity-1">
						<h3 class="c-font-40 c-font-white c-font-bold c-font-uppercase">Great<br/>Customer Care</h3>
						<p class="c-font-white c-font-18">
				...
				<div class="c-card c-bg-opacity-1">
						<h3 class="c-font-40 c-font-white c-font-bold c-font-uppercase">Awesome<br/>Features Pack</h3>
						<p class="c-font-white c-font-18">
							Lorem ipsum euismod dolor amet consetuer adipiscing elit sed diam nonummy euismod dolore
						</p>
					</div>
			...
			<ul class="c-grid">
				<li>
					<div class="c-card c-font-right c-bg-opacity-1">
						<h3 class="c-font-40 c-font-white c-font-bold c-font-uppercase">Unlimited<br/>Themed Layouts</h3>
						<p class="c-font-white c-font-18">
							Lorem ipsum euismod dolor amet consetuer adipiscing elit sed diam nonummy euismod dolore
						</p>
					</div>
				...
				<li>
					<div class="c-card c-img c-bg-img-center" style="background-image: url(/templates/frontend/assets/base/img/content/stock3/6.jpg)">
...
</div><!-- END: CONTENT/FEATURES/FEATURES-11 -->
</section>
...
<div class="c-content-box c-size-md c-bg-grey-1">
	<div class="container">
		<div class="c-content-feature-2-grid" data-auto-height="true" data-mode="base-height">
				...
				<div class="col-md-3 col-sm-6">
					<div class="c-content-feature-2" data-height="height" style="height: 161px;">
				...
				<div class="col-md-3 col-sm-6">
					<div class="c-content-feature-2" data-height="height" style="height: 161px;">
						...
						<h3 class="c-font-uppercase c-font-bold c-title">Mobile Apps Mobile</h3>
	...
	<div class="col-md-3 col-sm-6">
				...
				<div class="col-md-3 col-sm-6">
					<div class="c-content-feature-2" data-height="height" style="height: 161px;">
						...
						<h3 class="c-font-uppercase c-font-bold c-title">Consulting consulting cps</h3>
	...
	<div class="col-md-3 col-sm-6">
				...
				<div class="col-md-3 col-sm-6">
					<div class="c-content-feature-2" data-wow-delay1="2s" data-height="height" style="height: 161px;">
						<div class="c-icon-wrapper">
...
<section>
	...
	<div class="container">
		<div class="c-content-feedback-1 c-option-2">
			<div class="c-content-title-1">
				<h3 class="c-center c-font-white c-font-bold c-font-uppercase" style="padding-left: 18px;"> EnD<span class="c-font-black">eCo</span></h3>
				<div class="c-line-center c-left"></div><div class="c-line-center c-right"></div>
				<p class="c-center c-font-white" style="padding-left: 30px;">Contact us&nbsp;<span class="c-font-regular">&nbsp;&nbsp;We're here for you</span></p>
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="c-container c-bg-white c-bg-img-bottom-right" style="background-image:url(/templates/frontend/assets/base/img/content/misc/feedback_box_3.png)">
						...
						<div class="c-body">
						<div class="c-section" style="margin-bottom: 40px; margin-left: 20px;">
							<h3>EnDeCo inc.</h3>
						</div>
						<div class="c-section" style="margin: 20px;">
						...
						<div class="c-section" style="margin: 20px;">
							...
							<ul class="c-content-iconlist-1 c-theme" style="margin-top: 25px;">
							...
							<div class="c-tile-content c-bg-white c-arrow-left c-content-overlay">
								<div class="c-overlay-wrapper">
									<div class="c-overlay-content">
										...
										<a href="/templates/frontend/assets/base/img/content/stock/12_grey.jpg" data-lightbox="fancybox" data-fancybox-group="gallery-4">
											<i class="icon-magnifier"></i> </a>
									</div>
								</div>
								<div class="c-image c-overlay-object" data-height="height" style="background-image: url(/templates/frontend/assets/base/img/content/stock/12_grey.jpg)"></div>
							</div>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<div class="c-tile-content c-bg-white c-arrow-left c-content-overlay">
								<div class="c-overlay-wrapper">
									<div class="c-overlay-content">
										<a href="#"><i class="icon-link"></i></a>
										<a href="/templates/frontend/assets/base/img/content/stock/38_grey.jpg" data-lightbox="fancybox" data-fancybox-group="gallery-4">
											<i class="icon-magnifier"></i> </a>
									</div>
								</div>
								<div class="c-image c-overlay-object" data-height="height" style="background-image: url(/templates/frontend/assets/base/img/content/stock/38_grey.jpg)"></div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="c-tile-content c-bg-white c-content-v-center" data-height="height">
						...
						<div class="col-sm-6">
							<div class="c-tile-content c-bg-white c-arrow-right c-content-overlay">
								<div class="c-overlay-wrapper">
									<div class="c-overlay-content">
										<a href="#"><i class="icon-link"></i></a>
										<a href="/templates/frontend/assets/base/img/content/stock/21_grey.jpg" data-lightbox="fancybox" data-fancybox-group="gallery-4">
											<i class="icon-magnifier"></i> </a>
									</div>
								</div>
								<div class="c-image c-overlay-object" data-height="height" style="background-image: url(/templates/frontend/assets/base/img/content/stock/21_grey.jpg)"></div>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-sm-6">
							<div class="c-tile-content c-bg-white c-arrow-right c-content-overlay">
								<div class="c-overlay-wrapper">
									<div class="c-overlay-content">
										<a href="#"><i class="icon-link"></i></a>
										<a href="/templates/frontend/assets/base/img/content/stock/22_grey.jpg" data-lightbox="fancybox" data-fancybox-group="gallery-4">
											<i class="icon-magnifier"></i> </a>
									</div>
								</div>
								<div class="c-image c-overlay-object" data-height="height" style="background-image: url(/templates/frontend/assets/base/img/content/stock/22_grey.jpg)"></div>
							</div>
						</div>
					</div>
				</div>
...
<div class="c-content-box c-size-md c-bg-white">
	<div class="container">
		<div class="c-content-feedback-1 c-option-1">
			<div class="row">
				<div class="col-md-6">
					<div class="c-container c-bg-green c-bg-img-bottom-right" style="background-image:url(/templates/frontend/assets/base/img/content/misc/feedback_box_1.png)">
					...
					<div class="c-container c-bg-grey-1 c-bg-img-bottom-right" style="background-image:url(/templates/frontend/assets/base/img/content/misc/feedback_box_2.png)">
						<div class="c-content-title-1">
...
<div class="c-layout-go2top">
    ...
    <!-- BEGIN: CORE PLUGINS -->
	<!--[if lt IE 9]>
	<script src="/templates/frontend/assets/global/plugins/excanvas.min.js"></script>
	<![endif]-->
	<script src="/templates/frontend/assets/plugins/jquery.min.js" type="text/javascript" ></script>
	<script src="/templates/frontend/assets/plugins/jquery-migrate.min.js" type="text/javascript" ></script>
	<script src="/templates/frontend/assets/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript" ></script>
	<script src="/templates/frontend/assets/plugins/jquery.easing.min.js" type="text/javascript" ></script>
	<script src="/templates/frontend/assets/plugins/reveal-animate/wow.js" type="text/javascript" ></script>
	<script src="/templates/frontend/assets/demos/default/js/scripts/reveal-animate/reveal-animate.js" type="text/javascript" ></script>

	<!-- END: CORE PLUGINS -->

			<!-- BEGIN: LAYOUT PLUGINS -->
			<script src="/templates/frontend/assets/plugins/revo-slider/js/jquery.themepunch.tools.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/revo-slider/js/jquery.themepunch.revolution.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/revo-slider/js/extensions/revolution.extension.slideanims.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/revo-slider/js/extensions/revolution.extension.layeranimation.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/revo-slider/js/extensions/revolution.extension.navigation.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/revo-slider/js/extensions/revolution.extension.video.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/revo-slider/js/extensions/revolution.extension.parallax.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/owl-carousel/owl.carousel.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/counterup/jquery.waypoints.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/counterup/jquery.counterup.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/fancybox/jquery.fancybox.pack.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/smooth-scroll/jquery.smooth-scroll.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/typed/typed.min.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/slider-for-bootstrap/js/bootstrap-slider.js" type="text/javascript"></script>
			<script src="/templates/frontend/assets/plugins/js-cookie/js.cookie.js" type="text/javascript"></script>
				<!-- END: LAYOUT PLUGINS -->

	<!-- BEGIN: THEME SCRIPTS -->
	<script src="/templates/frontend/assets/base/js/components.js" type="text/javascript"></script>
	<script src="/templates/frontend/assets/base/js/components-shop.js" type="text/javascript"></script>
	<script src="/templates/frontend/assets/base/js/app.js" type="text/javascript"></script>
	<script>
	...
	<!-- END: THEME SCRIPTS -->
			...
			<!-- BEGIN: PAGE SCRIPTS -->
								<script src="/templates/frontend/assets/demos/default/js/scripts/revo-slider/slider-6.js" type="text/javascript"></script>
											<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDLPWnOu970nrxAY1eApfQb0UKBaxov3zg" type="text/javascript"></script>
											<script src="/templates/frontend/assets/plugins/gmaps/gmaps.js" type="text/javascript"></script>
											<script src="/templates/frontend/assets/demos/default/js/scripts/pages/contact.js" type="text/javascript"></script>
							<!-- END: PAGE SCRIPTS -->
